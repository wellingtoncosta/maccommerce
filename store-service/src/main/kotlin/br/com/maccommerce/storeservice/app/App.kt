package br.com.maccommerce.storeservice.app

import br.com.maccommerce.storeservice.app.config.EnvironmentConfig
import br.com.maccommerce.storeservice.app.config.appModules
import br.com.maccommerce.storeservice.app.web.handler.ErrorHandler
import br.com.maccommerce.storeservice.app.web.router.StoreRouter
...
object App : KoinComponent {
    ...
    private val routes: List<RoutingHttpHandler> by lazy { StoreRouter() }
